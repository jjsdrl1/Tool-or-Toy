...
export function PromptEditor() {
  ...
  return (
    <div className="flex flex-col gap-4 min-h-0">
      ...
      {/* ─── User Prompt (main edit area, fills available height) ─── */}
      <div className="pc-card overflow-hidden flex flex-col flex-1 min-h-[280px]">
        ...
        <textarea
          ...
          className="flex-1 w-full resize-none px-4 py-3 text-sm text-ink placeholder-ink-subtle focus:outline-none font-mono leading-relaxed bg-white"
        />
