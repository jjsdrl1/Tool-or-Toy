  ...
  return (
    <div className="flex flex-col gap-4 h-full overflow-y-auto">
      ...
      <div className="pc-card overflow-hidden flex-shrink-0">
        <div className="px-4 py-2.5 bg-gradient-to-r from-brand-50/60 to-white border-b border-gray-200 text-sm font-medium text-ink-soft flex items-center justify-between">
          <span>变量填充</span>
      ...
      {/* Preview */}
      <div className="pc-card overflow-hidden flex flex-col min-h-0">
        <div className="px-4 py-2.5 bg-gradient-to-r from-brand-50/60 to-white border-b border-gray-200 text-sm font-medium text-ink-soft flex-shrink-0">
          渲染预览
        </div>
        <div
