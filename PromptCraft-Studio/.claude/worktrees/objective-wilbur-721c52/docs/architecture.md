...
> 版本：v1.1 · 最后更新：2026-05-28 定位：面向 LLM 应用开发者的 Prompt 工程化管理平台
...
│  VersionManagePage  BatchTestPage  CodeExportPage           │
│  ModelPresetPage                                            │
└──────────────────────────┬──────────────────────────────────┘
                           │
               ┌───────────┴────────────┐
...
/projects                     项目列表
/projects/new                 创建新项目
/projects/:id                 项目详情（版本时间线）
/projects/:id/editor          Prompt 编辑器 + 运行
/projects/:id/editor/:vid     编辑指定版本
/projects/:id/compare         版本对比
/projects/:id/batch-test      批量测试
