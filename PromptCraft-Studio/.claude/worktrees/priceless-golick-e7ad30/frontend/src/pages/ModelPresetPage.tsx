  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-3">
        <button onClick={() => navigate('/projects')} className="text-gray-400 hover:text-indigo-600 text-sm">
          ← 返回
        </button>
        <span className="text-gray-300">|</span>
        <span className="text-lg font-semibold text-gray-900">模型配置</span>
      </nav>

      <main className="max-w-6xl mx-auto px-6 py-8 flex flex-col gap-6">
        {/* Header */}
        <div className="flex items-center justify-between">
          <p className="text-sm text-gray-500">管理模型 API 配置，支持 OpenAI、Anthropic、DeepSeek 等</p>
          <button
            onClick={openCreate}
